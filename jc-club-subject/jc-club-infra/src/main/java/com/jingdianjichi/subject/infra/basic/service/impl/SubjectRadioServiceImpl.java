...
public class SubjectRadioServiceImpl implements SubjectRadioService {
    ...
    @Override
    public List<SubjectRadio> queryByPage(SubjectRadio subjectRadio, Integer pageNo, Integer pageSize) {
        pageSize = pageSize * 4;
        pageNo = (pageNo - 1) * pageSize;
        return subjectRadioDao.queryByPage(subjectRadio, pageNo, pageSize);
    }
    ...
    public Long count() {
        ...
        return this.subjectRadioDao.count(subjectRadio);
    }
}
