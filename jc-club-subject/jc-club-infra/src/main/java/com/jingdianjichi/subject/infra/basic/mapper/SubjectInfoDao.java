...
public interface SubjectInfoDao {
    ...
    List<SubjectInfo> getReviewSubjects(SubjectInfo subjectInfo);

    Integer getCounts();

    List<SubjectInfo> queryByIdList(@Param("list") List<Long> idList);

    List<SubjectInfo> queryByIdListAndDiff(@Param("list") List<Long> idList,
